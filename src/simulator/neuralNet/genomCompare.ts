import { Gene, geneToNumber, Genome } from "./gene.js";
import { GenomComparisonMethod } from "./genomComparisonMethod.js";
...
export const jaro_winkler_distance = (genome1: Genome, genome2: Genome) => {
  let dw;
